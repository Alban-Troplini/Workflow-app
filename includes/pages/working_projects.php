...
<?php
  ...
  //pagination!
      ...
      $project_query_count = "SELECT COUNT(*) as pro_count FROM proejcts WHERE project_status='Working' OR project_status='Paused'";
      ...
      $sql_work = "SELECT * FROM proejcts WHERE";
      $sql_work .= " project_status='Working' OR project_status='Paused'";
      $sql_work .= " ORDER BY project_id DESC LIMIT {$page_1}, {$per_page}";
  // show all projects
      $result_all = $connect->query($sql_work);
...
?>
    ...
    <div class="row ">
       <div class="col-sm-2">
        ...
        <p><a class="btn btn-primary" href="pages/detailed.php?pro_id=<?php echo  $project_id; ?>&name=<?php echo  $project_name; ?>" role="button">View details &raquo;</a></p> 
       </div>
    ...
    <div class="col-sm-4">
      ...
      <div class="col-md-6 row">
           ...
           <form action="" method="POST">
                  ...
                  <button class="btn btn-warning float-right" name="working_project" type="submit">On Work</button>
          </form> 
          </div>
           ...
           <form action="" method="POST">
                  <input type="hidden" name="project_id" value="<?php echo $project_id;?>">
                  <button class="btn btn-danger float-right" name="pause_project" type="submit">Pause</button>
          </form>
          </div>
           ...
           <form action="" method="POST">
                  <input type="hidden" name="project_id" value="<?php echo $project_id;?>">
                  <button class="btn btn-success float-right" name="to_test_project" type="submit">Testing</button>
          </form>
    ...
    <hr>
        ...
        for($i=1; $i <= $count_projects; $i++ ){
          ...
          if($i == $page){
            ...
            echo "<li class='page-item'><a class='active_link page-link' href='index.php?ins=working_projects.php&ul={$i}'>{$i}</a></li>";

          } else {

           echo "<li class='page-item'><a class='page-link' href='index.php?ins=working_projects.php&ul={$i}'>{$i}</a></li>";
        }
      }
        ?>
        </ul>
